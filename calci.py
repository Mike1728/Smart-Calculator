...
l1 = Label(win , text='I am a smart calculator',width=20 , padx=10)
l1.place(x=110,y=10)
l2 = Label(win , text='My name is Calci' , padx=3)
l2.place(x=130,y=40)
l3 = Label(win , text='What can i help you' , padx=10)
...
b1 = Button(win , text='Only this' ,command=calculate)
